window.onload = function () {
  ...
  file.onchange = function () {
    ...
    console.log("TOTAL WIDTH: ", 118 * 10 + 118 * barWidth); // (total space between bars)+(total width of all bars)
    ...
    function renderFrame() {
      ...
      ctx.fillStyle = "rgba(3,19,33,0.2)"; // Clears canvas before rendering bars (black with opacity 0.2)
      ctx.fillRect(0, 0, WIDTH, HEIGHT); // Fade effect, set opacity to 1 for sharper rendering of bars

      let r, g, b;
      let bars = 62; // Set total number of bars you want per frame
